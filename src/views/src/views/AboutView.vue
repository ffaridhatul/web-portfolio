    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 3,
          name: 'java',
          imageUrl: 'https://img.icons8.com/?size=96&id=13679&format=png',
          status: 'Advanced'
        },
        {
          id: 4,
        ...
        },
        {
          id: 5,
          name: 'C#',
          imageUrl: 'https://img.icons8.com/?size=96&id=40669&format=png',
          status: 'Advance'
        },    
        {
          id: 6,
      ...
      tools: [
        ...
        },
        {
          ...
          imageUrl: 'https://www.pinclipart.com/picdir/middle/219-2192031_svg-studio-visual-visual-studio-code-logo-clipart.png',
          status: 'Text Editor'
        },
      ]
    };
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="../../public/img/Formal.jpg" alt="Foto">
        </div>
        <div class="md:w-6/11">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hello, everyone! <span class="text-amber-200">I’m Faridhatul Zikri</span>, a dedicated Software Engineer with over 1 year of experience in developing innovative and efficient software solutions. I have a passion for solving complex problems and creating applications that not only function well but also provide an exceptional user experience.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; In addition to my core software engineering skills, I specialize in building websites that are both functional and user-friendly while maintaining an attractive design. I bring a personal touch to each project, ensuring that the websites I develop capture attention and are easy to navigate. My goal is to convey your message and identity in the most creative and effective way possible. Whether it's enhancing existing applications or developing new web solutions, I am committed to delivering high-quality results that meet your unique needs.
          </p>
        </div>
